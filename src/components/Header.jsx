...
const Header = () => {
  return (
    <div>
      ...
      <div
        id="main-header"
        className="flex justify-between items-center pl-14 pr-16"
      >
        ...
        <ul className="flex items-center gap-6 sub-header-list">
          ...
          <li className="text-xl font-medium tracking-wide">Men
          <div className="sub-header">
              <ul className="w-full flex justify-between">
                <li>
                  <ul className="flex flex-col gap-6">
          ...
          <li className="text-xl font-medium tracking-wide">Women
          <div className="sub-header">
              <ul className="w-full flex justify-between">
                <li>
                  <ul className="flex flex-col gap-6">
          ...
          <li className="text-xl font-medium tracking-wide">Kids
          <div className="sub-header">
              <ul className="w-full flex justify-between">
                <li>
                  <ul className="flex flex-col gap-6">
          ...
          <li className="text-xl font-medium tracking-wide">Sale
          <div className="sub-header">
              <ul className="w-full flex justify-between">
                <li>
                  <ul className="flex flex-col gap-6">
